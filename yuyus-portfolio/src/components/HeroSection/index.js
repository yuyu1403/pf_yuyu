...
const HeroSection = () => {
  ...
  <div className="heroContainer">
    ...
    <div className="heroContainer__footer">
      ...
      <h2>
        <span className="blue">>Bonjour,</span><br></br>
        <span className="purple">>Je suis Younes,</span><br></br>
        <span className="turquoise">>Développeur en formation,</span><br></br> 
        <span className="purple">>Bienvenue sur mon portfolio.</span><br></br>
      </h2>
      </section>
